    ...
    <div class="container">
      <h3 class="prev-indent-bot">Restaurant List</h3>
		...
		while (oci_fetch($stid)){
			echo "<h3 class='prev-indent-bot'><a href='restarurant.php?RID=$rid' style='text-decoration: none'>$rname</a></h3>";
			echo "<hr>";
			echo "<ul class='price-list p2>'";				
			echo "<li><span><img src='images/$i.jpg' width='80' height='60'></span></li><br>";				
		...
		$sql = "select u.FNAME, r.content from review r, useraccount u
					where rid=$rid AND r.USERID = u.USERID";
			//echo $sql;
		$stid = oci_parse($connection,$sql);
		...
		while(oci_fetch($stid)){
			echo "<hr>";
			echo "<ul>";				echo "<li>".$fname."</li>";
			echo "<li>".$reviewcontent."</li>";
			echo "</ul>";
		}
		//&&&&
